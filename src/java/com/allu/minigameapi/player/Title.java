...
public class Title {
    ...
    public void send(Player player) {
        ...
        try {
            ...
            // NMS Classes
            Class<?> clsPacketPlayOutTitle = MinigameAPI.plugin.getClass("PacketPlayOutTitle");
            Class<?> clsPacket = MinigameAPI.plugin.getClass("Packet");
            Class<?> clsIChatBaseComponent = MinigameAPI.plugin.getClass("IChatBaseComponent");
            Class<?> clsChatSerializer = MinigameAPI.plugin.getClass("IChatBaseComponent$ChatSerializer");
            Class<?> clsEnumTitleAction = MinigameAPI.plugin.getClass("PacketPlayOutTitle$EnumTitleAction");
